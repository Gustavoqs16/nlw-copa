...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className='max-w-[1124px] p-12 h-screen mx-auto gap-28 grid grid-cols-2 items-center'>
      <main>
      ...
      <Image
        src={appPreviewImg}
        alt="Dois celulares exibindo uma prévia da aplicação móbel do NLW Copa"
        quality={100}
      />
    </div>
  )
